...
exports.initMqtt = exports.MQTTClient = exports.MqttJS = void 0;
...
class MQTTClient {
    constructor(uri, topics, clientId) {
        this.topics = [];
        this.uri = uri;
        clientId = clientId !== null && clientId !== void 0 ? clientId : 'app' + Date.now();
...
function initMqtt(topics, config) {
    ...
    if (!mqttClient) {
        mqttClient = new MQTTClient(uri, topics, config.clientId);
